...
class MacToPhoneTab:
    ...
    def setup_widgets(self):
        ...
        tk.Label(self.scrollable_frame,
                 text="Enter phone numbers and MAC addresses (comma-separated, one pair per line):").grid(row=0,
                                                                                                          column=0,
                                                                                                          padx=5,
                                                                                                          pady=5,
                                                                                                          sticky='w')
        ...
        tk.Button(self.scrollable_frame, text="Add Numbers", command=self.parse_and_add_numbers).grid(row=2, column=0,
                                                                                                      padx=5, pady=5,
                                                                                                      sticky='w')

        # Display field
        tk.Label(self.scrollable_frame, text="Current Numbers and MACs Displayed:").grid(row=3, column=0, padx=5,
                                                                                         pady=5, sticky='w')
        ...
        tk.Button(self.scrollable_frame, text="Clear Display", command=self.clear_display).grid(row=5, column=0, padx=5,
                                                                                                pady=5, sticky='e')

        # Sorted input field
        tk.Label(self.scrollable_frame, text="Enter sorted phone numbers:").grid(row=6, column=0, padx=5, pady=5,
                                                                                 sticky='w')
        ...
        tk.Button(self.scrollable_frame, text="Sort and Display", command=self.sort_and_display).grid(row=8, column=0,
                                                                                                      padx=5, pady=5,
                                                                                                      sticky='w')
        tk.Button(self.scrollable_frame, text="Clear Sorted Entry", command=self.clear_sorted_entry).grid(row=8,
                                                                                                          column=0,
                                                                                                          padx=5,
                                                                                                          pady=5,
                                                                                                          sticky='e')
