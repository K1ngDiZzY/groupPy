...
#             extension = simpledialog.askstring("Input", "Enter the extension for HG frames line:")
#             if extension is not None and extension != "":
#                 adding_comma = ', '.join(phone_numbers)
#                 log_messages.append(f"Added - Added {adding_comma} to HG frames line extension {extension}")
#             else:
