...
class MacToPhoneTab:
    ...
    def setup_widgets(self):
        ...
        # tk.Button(self.tab_mac_to_phone, text="Clear Number history", command=self.clear_numbers).grid(row=2, column=0, padx=5, pady=5, sticky='e')
        ...
        tk.Button(self.tab_mac_to_phone, text="Clear Display", command=self.clear_display).grid(row=5, column=0, padx=5, pady=5, sticky='e')
        ...
        tk.Button(self.tab_mac_to_phone, text="Clear Sorted Entry", command=self.clear_sorted_entry).grid(row=7, column=0, padx=5, pady=5, sticky='e')
